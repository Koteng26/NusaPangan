...
<div class="np-header" style="background: linear-gradient(135deg, #1A237E, #283593, #3949AB);">
    ...
    <p>Pantau harga pangan, produksi beras, dan program MBG dari satu dashboard.</p>
</div>
...
<div style="display:flex;gap:12px;flex-wrap:wrap;margin-bottom:20px;">
    <div style="flex:1;min-width:140px;background:linear-gradient(135deg,#1B5E20,#2E7D32);border-radius:14px;padding:18px;color:#fff;box-shadow:0 4px 16px rgba(27,94,32,0.2);">
        <div style="font-size:0.75rem;opacity:0.8;">👨‍🌾 Petani Verified</div>
    ...
    <div style="flex:1;min-width:140px;background:linear-gradient(135deg,#0D47A1,#1565C0);border-radius:14px;padding:18px;color:#fff;box-shadow:0 4px 16px rgba(13,71,161,0.2);">
        <div style="font-size:0.75rem;opacity:0.8;">📦 Journey Active</div>
        <div style="font-size:1.8rem;font-weight:900;margin-top:4px;">{len(df_journeys)}</div>
    </div>
    <div style="flex:1;min-width:140px;background:linear-gradient(135deg,#4A148C,#6A1B9A);border-radius:14px;padding:18px;color:#fff;box-shadow:0 4px 16px rgba(74,20,140,0.2);">
    ...
    <div style="flex:1;min-width:140px;background:linear-gradient(135deg,#BF360C,#E65100);border-radius:14px;padding:18px;color:#fff;box-shadow:0 4px 16px rgba(191,54,12,0.2);">
        <div style="font-size:0.75rem;opacity:0.8;">💰 Beras DKI</div>
        <div style="font-size:1.8rem;font-weight:900;margin-top:4px;">Rp {avg_dki:,.0f}</div>
    </div>
    <div style="flex:1;min-width:140px;background:linear-gradient(135deg,#E65100,#FF8F00);border-radius:14px;padding:18px;color:#fff;box-shadow:0 4px 16px rgba(230,81,0,0.2);">
        <div style="font-size:0.75rem;opacity:0.8;">💰 Beras Banten</div>
        <div style="font-size:1.8rem;font-weight:900;margin-top:4px;">Rp {avg_btn:,.0f}</div>
    </div>
</div>
""", unsafe_allow_html=True)
