...
# Avatar
_avatar_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", "assets", "farmer-avatar.png")
try:
    with open(_avatar_path, "rb") as _f:
        _avatar_b64 = base64.b64encode(_f.read()).decode()
    AVATAR_HTML = f'<img src="data:image/png;base64,{_avatar_b64}" style="width:100%;height:100%;object-fit:cover;">'
except:
    AVATAR_HTML = '<div style="font-size:2.5rem;display:flex;align-items:center;justify-content:center;height:100%;">👨‍🌾</div>'
...
<div style="background:white;border-radius:16px;padding:20px;border:1px solid #c8e6c9;box-shadow:0 2px 12px rgba(27,94,32,0.06);margin-bottom:16px;">
    <div style="display:flex;gap:16px;align-items:center;">
        <div style="width:72px;height:72px;border-radius:50%;overflow:hidden;flex-shrink:0;border:3px solid #c8e6c9;">
            {AVATAR_HTML}
        </div>
        <div style="flex:1;">
